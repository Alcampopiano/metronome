...
if not all([SECRET_KEY, ADMIN_USERNAME, ADMIN_PASSWORD]):
    raise RuntimeError("SECRET_KEY, ADMIN_USERNAME, and ADMIN_PASSWORD environment variables must be set")
...
<style>
  *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .subtitle {{ font-size: 0.7rem; color: var(--text-muted); letter-spacing: 0.06em; text-transform: uppercase; margin-top: -20px; }}
...
# ---------------------------------------------------------------------------
# Public song API (used by the main metronome page — no auth needed)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Protected admin API (POST/PUT/DELETE require valid session cookie)
# ---------------------------------------------------------------------------
